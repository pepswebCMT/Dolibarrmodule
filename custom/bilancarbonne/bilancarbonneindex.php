...
if (isModEnabled('bilancarbonne') && $user->hasRight('bilancarbonne', 'read')) {
	...
	$sql.= " FROM ".MAIN_DB_PREFIX."bilancarbonne_myobject as s";
...
// Ajout de la récupération des données de la table llx_boxes
// $sql = "SELECT * FROM " . MAIN_DB_PREFIX . "boxes";
// $resql = $db->query($sql);
...
// 	} else {
// 		print '<tr class="oddeven">';
// 		print '<td colspan="4" class="opacitymedium">' . $langs->trans("NoDataFound") . '</td>';
// 		print '</tr>';
// 	}
// 	print '</table>';
// 	$db->free($resql);
